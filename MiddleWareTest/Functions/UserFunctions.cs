...
namespace MiddleWareTest.Functions
{
    public class UserFunctions
    {
        ...
        [Authorized(new[] {UserType.Admin, UserType.Owner})]
            ...
            FunctionContext executionContext)
        {
            ...
            if (!AuthorizationService.UserAuthorized(authAttribute.AllowedUserTypes,
                executionContext.Items["Email"].ToString())) throw new UnauthorizedGoogleException();
